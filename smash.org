...
So far, I have used transfer learning techniques to train a VGG16-based neural network to classify images of single characters.  See the [[file:classification.ipynb][classification notebook]] for details.
