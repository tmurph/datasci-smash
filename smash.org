...
The following describes the code to preprocess previously generated images for keras modeling.  As with the [[#Data-Generation][data generation]] documentation, not all code will be covered.
